...
def load_data(pkl_file):
    ...
    try:
        ...
        for i in cnf_code:
            time.sleep(10)
            driver.get(f'taget_url/{i}?confirmationCode={i}&print=true')
            time.sleep(20)
            dic={}
        ...
        df1=df1.reset_index()
        df1=df1[['Confirmation Code','Airbnb Account ID','Resort fee']]
        df1.rename(columns={'Confirmation Code':'confirmation_code','Airbnb Account ID':'airbnb_account_id','Resort fee':'host_resort_fee'},inplace=True)
